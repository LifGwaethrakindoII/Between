...
public class SensorSystem3DInspector : Editor
{
	...
	private void DrawSubsystems()
	{
		...
		VoidlessEditorGUILayout.ShowSerializedPropertySizeConfiguration(ref subsystems, "Subsystems' ");
		EditorGUILayout.Space();
		...
		for(int i = 0; i < sensorsystem3D.subsystems.Length; i++)
		{
			...
			EditorGUILayout.Space();
			VoidlessEditorGUILayout.ShowSerializedPropertySizeConfiguration(ref sensorsData, subsystemLabel + " Sensors' Data ");
