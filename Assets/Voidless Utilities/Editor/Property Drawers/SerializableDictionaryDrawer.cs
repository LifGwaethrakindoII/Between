...
public class SerializableDictionaryDrawer : VoidlessPropertyDrawer
{
	...
	public override void OnGUI (Rect _position, SerializedProperty _property, GUIContent _label)
	{
		...
		if(_property.isExpanded)
		{
			...
			AddVerticalSpace();
			positionRect.height = SPACE_VERTICAL;
			VoidlessEditorGUI.ShowDictionarySerializedPropertySizeConfiguration(ref keys, ref values, positionRect.WithHeight(EditorGUIUtility.singleLineHeight));
