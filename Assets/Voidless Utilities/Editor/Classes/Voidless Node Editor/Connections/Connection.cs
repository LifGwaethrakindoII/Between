...
#region Getters/Setters:
	...
	/// <param name="_handlesButtonPickSize">Handles's button pick size.</param>
	/// <param name="onClickRemoveConnection">Action called when this Connection has to be removed.</param>
	new public static Connection NewInstance(ConnectionPoint _inPoint, ConnectionPoint _outPoint, PointAllignmentTypes _pointAllignmentType, Color _beizerLineColor, float _beizerLineTangent, float _beizerLineWidth, float _handlesButtonSize, float _handlesButtonPickSize,Action<Connection> onClickRemoveConnection)
	{
