...
#region Getters/Setter:
	...
	/// <param name="_connectionStyle">Connection Point's GUI Style.</param>
	/// <param name="onClickConnectionPoint">Action called when the Connection Point is clicked.</param>
	new public static ConnectionPoint NewInstance(Node _node, float _pointWidth, float _pointHeight, float _rectWidthOffset, float _rectHeightOffset, PointAllignmentTypes _allignmentType, PointTypes _pointType, GUIStyle _connectionStyle, Action<ConnectionPoint> onClickConnectionPoint)
	{
