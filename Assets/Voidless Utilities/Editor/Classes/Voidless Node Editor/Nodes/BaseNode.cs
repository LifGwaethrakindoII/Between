...
#region Getters/Setters:
	...
	new public static T NewInstance(Vector2 _position, float _width, float _height, float _fieldHorizontalOffset, float _fieldHeight, GUIStyle _nodeStyle, GUIStyle _selectedNodeStyle, Action<T> onRemoveNode, Action<T, Vector2> onCopyNode)
	{
