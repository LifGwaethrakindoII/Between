...
{
public static class VoidlessEditorGUILayout
{
	...
	{
		int maxArraySize = VoidlessArray.GetArrayMaxLength(_arrays);
	...
	{
		int maxListSize = VoidlessList.GetListsMaxLength(_lists);
