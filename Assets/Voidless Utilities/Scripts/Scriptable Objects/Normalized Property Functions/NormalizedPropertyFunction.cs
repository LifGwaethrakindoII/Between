...
{
	protected const string PATH_NORMALIZED_PROPERTY_FUNCTIONS = VoidlessString.PATH_SCRIPTABLE_OBJECTS + " / Normalized Property Functions"; 	/// <summary>Normalized Property Functions' Base Path.</summary>
