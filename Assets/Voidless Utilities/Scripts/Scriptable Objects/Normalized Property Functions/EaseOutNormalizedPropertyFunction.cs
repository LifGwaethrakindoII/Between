...
{
[CreateAssetMenu(menuName = PATH_NORMALIZED_PROPERTY_FUNCTIONS + "/Ease-Out")]
public class EaseOutNormalizedPropertyFunction : NormalizedPropertyFunction
{
	...
	{
		return VoidlessMath.EaseOut(t, exponent);
	}
}
}