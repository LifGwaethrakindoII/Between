...
#region UnityMethods:
	...
	void Start ()
	{
		ObjectPool.Instance.CreateObjectsPool<T>(spawnEntity, maxQuantity);	
	}
#endregion
	...
	protected virtual void SpawnNewEntity()
	{
		...
		T spawn = ObjectPool.Instance.RecyclePoolObject<T>(spawnEntity, newSpawnPoint.position, newSpawnPoint.rotation);
