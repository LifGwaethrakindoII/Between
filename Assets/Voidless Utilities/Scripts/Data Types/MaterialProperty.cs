...
{
[Serializable]
public struct MaterialProperty : ISerializationCallbackReceiver
{
	...
	/// <summary>Implicit string to MaterialProperty operator.</summary>
	public static implicit operator MaterialProperty(string _tag) { return new MaterialProperty(_tag); }

	/// <summary>Implicit Material to int property, by returning its ID.</summary>
	public static implicit operator int(MaterialProperty _property) { return _property.ID; }

	/// <summary>MaterialPRoperty constructor.</summary>
	/// <param name="_tag">Material Property's Tag.</param>
	public MaterialProperty(string _tag) : this()
	{
		tag = _tag;
	}
