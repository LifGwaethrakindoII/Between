...
{
public static class VoidlessGL
{
	...
	public static void DrawCuadraticBeizerCurve(Vector3 _initialPoint, Vector3 _finalPoint, Vector3 _tangent, int _timeSplit, Color _color)
	{
		...
		{
			Vector3 newPosition = VoidlessMath.CuadraticBeizer(_initialPoint, _finalPoint, _tangent, (i * timeSplitInverseMultiplicative));
		...
		for(int i = 0; i < _timeSplit - 1; i++)
		{
			...
			Vector3 newStartPosition = VoidlessMath.CuadraticBeizer(_initialPoint, _finalPoint, _tangent, (i * timeSplitInverseMultiplicative));
			Vector3 newFinalPosition = VoidlessMath.CuadraticBeizer(_initialPoint, _finalPoint, _tangent, ((i + 1) * timeSplitInverseMultiplicative));
	...
	public static void DrawCubicBeizerCurve(Vector3 _initialPoint, Vector3 _finalPoint, Vector3 _startTangent, Vector3 _endTangent, int _timeSplit, Color _color)
	{
		...
		for(int i = 0; i < _timeSplit; i++)
		{
			Vector3 newPosition = VoidlessMath.CubicBeizer(_initialPoint, _finalPoint, _startTangent, _endTangent, (i * timeSplitInverseMultiplicative));
			GL.Vertex3(newPosition.x, newPosition.y, newPosition.z);	
		}
		...
		for(int i = 0; i < _timeSplit - 1; i++)
		{
			...
			Vector3 newStartPosition = VoidlessMath.CubicBeizer(_initialPoint, _finalPoint, _startTangent, _endTangent, (i * timeSplitInverseMultiplicative));
			Vector3 newFinalPosition = VoidlessMath.CubicBeizer(_initialPoint, _finalPoint, _startTangent, _endTangent, ((i + 1) * timeSplitInverseMultiplicative));
