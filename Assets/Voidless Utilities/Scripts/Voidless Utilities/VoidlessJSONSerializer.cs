...
{
public static class VoidlessJSONSerializer
{
	...
	public static void SerializeToJSON<T>(this T _item, string _path)
	{
		...
		catch(Exception exception) { Debug.LogWarning("[VoidlessJSONSerializer] Catched Exception while trying to serialize to JSON: " + exception.Message ); }
	}
	...
	public static T DeserializeFromJSONFromPath<T>(string _path)
	{
		...
		catch(Exception exception) { Debug.LogWarning("[VoidlessJSONSerializer] Catched Exception while trying to deserialize object of type " + typeof(T) + " : " + exception.Message); }
	...
	public static T DeserializeFromJSONFromTextAsset<T>(TextAsset _file)
	{
		...
		catch(Exception exception) { Debug.LogWarning("[VoidlessJSONSerializer] Catched Exception while trying to deserialize object of type " + typeof(T) + " from TextAsset: " + exception.Message); }
	...
	public static void SerializeToJSONIntoTextAsset<T>(this T _item, TextAsset _file)
	{
		...
		catch(Exception exception) { Debug.LogWarning("[VoidlessJSONSerializer] Catched Exception while trying to serialize JSON into TextAsset: " + exception.Message); }
	}
#endif
}
}