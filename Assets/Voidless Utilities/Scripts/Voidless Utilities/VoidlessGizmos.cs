...
public static class VoidlessGizmos
{
	...
	public static void DrawCuadraticBeizerCurve(Vector3 _initialPoint, Vector3 _finalPoint, Vector3 _tangent, int _timeSplit, Color _color/*, bool _debugPoints*/)
	{
		...
		{
			Vector3 initialPoint = VoidlessMath.CuadraticBeizer(_initialPoint, _finalPoint, _tangent, (i * timeSplitInverseMultiplicative));
			Vector3 finalPoint = VoidlessMath.CuadraticBeizer(_initialPoint, _finalPoint, _tangent, ((i + 1) * timeSplitInverseMultiplicative));
	...
	public static void DrawCubicBeizerCurve(Vector3 _initialPoint, Vector3 _finalPoint, Vector3 _startTangent, Vector3 _endTangent, int _timeSplit, Color _color/*, bool _debugPoints*/)
	{
		...
		for(int i = 0; i < _timeSplit -1; i++)
		{
			Vector3 initialPoint = VoidlessMath.CubicBeizer(_initialPoint, _finalPoint, _startTangent, _endTangent, (i * timeSplitInverseMultiplicative));
			Vector3 finalPoint = VoidlessMath.CubicBeizer(_initialPoint, _finalPoint, _startTangent, _endTangent, ((i + 1) * timeSplitInverseMultiplicative));
			Gizmos.DrawLine(initialPoint, finalPoint);
		}
#endif
    }
