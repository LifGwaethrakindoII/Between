...
#region Getters/Setters:
	...
	/// <param name="_id">This Node's ID.</param>
	new public static RootLevelFlowNode NewInstance(int _id)
	{
	...
	/// <summary>RootLevelFlowNode ScriptableObject's constructor.</summary>
	/// <param name="_childNodes">Root Node's childs.</param>
	new public static RootLevelFlowNode NewInstance(params ILevelFlowNode[] _childNodes)
	{
		RootLevelFlowNode newRoot = CreateInstance<RootLevelFlowNode>();
	...
	/// <param name="_id">This Node's ID.</param>
	/// <param name="_childNodes">Root Node's childs.</param>
	new public static RootLevelFlowNode NewInstance(int _id, params ILevelFlowNode[] _childNodes)
	{
		RootLevelFlowNode newRoot = CreateInstance<RootLevelFlowNode>();
