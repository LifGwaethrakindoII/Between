...
{
public struct SelectorLevelFlowNode : ILevelFlowNode
{
...
#region Getters/Setters:
	...
	/// <summary>SelectorLevelFlowNode constructor.</summary>
	/// <param name="_id">This Node's ID.</param>
	public SelectorLevelFlowNode(int _id) : this()
	{
		ID = _id;
	}
	...
	public SelectorLevelFlowNode(params ILevelFlowNode[] _childNodes) : this()
	{
		hasIDAssigned = false;
	...
	/// <param name="_id">This Node's ID.</param>
	/// <param name="_childNodes">Root Node's childs.</param>
	public SelectorLevelFlowNode(int _id, params ILevelFlowNode[] _childNodes) : this()
	{
		ID = _id;
		AddNodes(_childNodes);
	}
